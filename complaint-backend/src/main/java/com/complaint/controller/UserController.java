...
import com.complaint.entities.Role;
import com.complaint.entities.User;
import com.complaint.entities.UserRole;
...
public class UserController {
	...
	public void createAdmin() {
		User admin = new User();
		admin.setUsername("lokeshaditya");
		admin.setPassword("lokesh@2721");
		admin.setFirstName("gandam");
		admin.setLastName("lokesh");
		admin.setEmail("lokeshaditya@gmail.com");
		admin.setPinCode(110001);
		admin.setPhone("+919133723123");
